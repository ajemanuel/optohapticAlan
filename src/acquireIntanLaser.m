function acquireIntanLaser(protocol)
    ...
    switch protocol
        case 'randSquareWithOffset'
            ...
            edgeLength = 3000; % in microns      
            offsetX = -35000; % in microns  [-26000, , -24000, 26000 ]  empirical range [-x, +x, -y, +y]
            offsetY = 0; % in microns
            numStim = 100; 
            dwellTime = 0.0004;  %.001 singes FST ruler
            ISI = 5;  %empirical min is .001 seconds (thorlabs mirrors confined to 1cm^2)
